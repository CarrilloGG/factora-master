...
$(function () {
    ...
    $('#tblProducts tbody')
        ...
        .on('change', 'input[name="dscto"]', function () {
            ...
            $('td:eq(-2)', tblProducts.row(tr.row).node()).html('Q' +promotions.details.products[tr.row].total_dscto.toFixed(2));
            $('td:eq(-1)', tblProducts.row(tr.row).node()).html('Q' +promotions.details.products[tr.row].price_final.toFixed(2));
        })
