...
$(function () {
    ...
    $('#data tbody')
        ...
        .on('click', 'a[rel="detail"]', function () {
            ...
            invoice.push({'id': 'Subtotal', 'name': 'Q' +row.subtotal});
            invoice.push({'id': 'Iva', 'name': row.iva + ' %'});
            invoice.push({'id': 'Total Iva', 'name': 'Q' +row.total_iva});
            invoice.push({'id': 'Descuento', 'name': row.dscto + ' %'});
            invoice.push({'id': 'Total Descuento', 'name': 'Q' +row.total_dscto});
            invoice.push({'id': 'Total a pagar', 'name': 'Q' +row.total});
            if (row.payment_method.id === 'efectivo') {
                invoice.push({'id': 'Efectivo', 'name': 'Q' +row.cash});
                invoice.push({'id': 'Cambio', 'name': 'Q' +row.change});
                ...
                invoice.push({'id': 'Monto a debitar', 'name': 'Q' +row.amount_debited});
