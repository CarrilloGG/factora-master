...
$(function () {
    ...
    select_ctas_collect = $('select[name="ctas_collect"]');
    ...
    select_ctas_collect.select2({
        ...
        .on('select2:select', function (e) {
            fv.revalidateField('ctas_collect');
