                    ...
                    validators: {
                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    pattern: 'number',
                                    number: frmPurchase.querySelector('[name="number"]').value,
                ...
                name: {
                    validators: {
                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    parameter: frmProvider.querySelector('[name="name"]').value,
                                    pattern: 'name',
                ...
                ruc: {
                    validators: {
                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    parameter: frmProvider.querySelector('[name="ruc"]').value,
                                    pattern: 'ruc',
                                    action: 'validate_provider'
                                };
                            },
                ...
                mobile: {
                    validators: {
                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    parameter: frmProvider.querySelector('[name="mobile"]').value,
                                    pattern: 'mobile',
                                    action: 'validate_provider'
                                };
                            },
                ...
                email: {
                    validators: {
                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    parameter: frmProvider.querySelector('[name="email"]').value,
                                    pattern: 'email',
                                    action: 'validate_provider'
                                };
                            },
...
$(function () {
    ...
    $('#tblProducts tbody')
        ...
        .on('change', 'input[name="cant"]', function () {
            ...
            $('td:last', tblProducts.row(tr.row).node()).html('Q' +purchase.details.products[tr.row].subtotal.toFixed(2));
        })
